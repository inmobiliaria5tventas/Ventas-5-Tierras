 ...
 * Project: Los Naranjos (Client Version)
 */

const DataModule = (() => {
    const STORAGE_KEY = 'client_hacienda_naranjos_lotes'; 
    ...
    function processBatch(geoJson, defaultEstado = 'Disponible') {
        ...
        geoJson.features.forEach(f => {
            ...
            let precio = sanitizeNumber(findProp(f.properties, MAPPING.precio) || 23000000);
