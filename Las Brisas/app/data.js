...
const DataModule = (() => {
    ...
    const SYNC_QUEUE_KEY = 'hacienda_brisas_sync_queue';
    const LAST_UPDATE_KEY = 'hacienda_brisas_last_update';

    // ── Raw GeoJSON from qgis2web (loaded in index.html) ──
    const rawDisponibles = typeof json_Disponibles_5 !== 'undefined' ? json_Disponibles_5 : { "type": "FeatureCollection", "features": [] };
    const rawReservadas = typeof json_Reservadas_6 !== 'undefined' ? json_Reservadas_6 : { "type": "FeatureCollection", "features": [] };
    const rawVendidas = typeof json_Vendidas_4 !== 'undefined' ? json_Vendidas_4 : { "type": "FeatureCollection", "features": [] };
