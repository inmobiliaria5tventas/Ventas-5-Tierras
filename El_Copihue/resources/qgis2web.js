...
map.getView().fit([-7991065.879923, -4317773.827692, -7989086.437541, -4316696.673453], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Hacienda El Copihue</h2>';
        return titleElement;
    })(),
