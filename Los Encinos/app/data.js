...
const DataModule = (() => {
    ...
    const SYNC_QUEUE_KEY = 'hacienda_encinos_sync_queue';
    const LAST_UPDATE_KEY = 'hacienda_encinos_last_update';

    // ── Raw GeoJSON from qgis2web (loaded in index.html) ──
    const rawDisponibles = typeof json_Disponibles_4 !== 'undefined' ? json_Disponibles_4 : { "type": "FeatureCollection", "features": [] };
    const rawReservadas = typeof json_Reservadas_5 !== 'undefined' ? json_Reservadas_5 : { "type": "FeatureCollection", "features": [] };
    const rawVendidas = typeof json_Vendidas_3 !== 'undefined' ? json_Vendidas_3 : { "type": "FeatureCollection", "features": [] };
            ...
            fc.features.forEach(f => {
                ...
                allFeatures.push({
                    ...
                    properties: {
                        ...
                        fid: props.fid,
                        area: props.Area || props.Hectareas || '',
